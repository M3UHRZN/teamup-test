...
export default function Page() {
  return (
    <div className='h-screen w-screen bg-black overflow-hidden'>
      <main className='h-full w-full relative flex items-center justify-center'>
        {/* Animated Background */}
        ...
        {/* SignIn Component with backdrop */}
        <div className='relative z-10 bg-gradient-to-br from-indigo-900/80 via-purple-900/80 to-blue-800/80 border border-purple-400/30 rounded-3xl shadow-2xl backdrop-blur-sm p-8'>
          <SignIn />
        </div>
      </main>
    </div>
